...
function loadstring(game:HttpGet("https://raw.githubusercontent.com/giaotrinhhoc/Api/refs/heads/main/Dough.txt"))()
    local servers = {}
...
Converted["_TextLabel"].Text = "W-MB | Hop Dough king"
